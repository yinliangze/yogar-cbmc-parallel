...
public:
  ...
  virtual literalt lequal(const bvt &bv0, const bvt &bv1)=0;
  virtual literalt lequal(const bvt &bv0, const bvt &bv1, const literalt& x)=0;
  ...
  virtual int get_process_id(){return 0;}
  virtual int  nClauses() {return 0;}
};
