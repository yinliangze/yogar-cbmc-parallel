...
public:
  ...
  public:
    ...
    irep_idt keep_counter(const irep_idt &identifier)
    {
      return name(identifier, current_names[identifier]);
    }
  ...
  void rename(exprt &expr, const namespacet &ns, levelt level=L2, const bool array_assign = false, int* struct_member = NULL);
  void rename_unique(exprt &expr, const namespacet &ns, std::map<irep_idt, int>& symbol_map, levelt level=L2, const bool array_assign = false, int* struct_member = NULL);
  ...
  std::map<irep_idt, symex_targett::sourcet> shared_rw_source;
  ...
  bool l2_thread_read_encoding(symbol_exprt &expr, const namespacet &ns, const bool array_assign = false, int* struct_member = NULL);
  bool l2_thread_read_encoding_unique(symbol_exprt &expr, const namespacet &ns, std::map<irep_idt, int>& symbol_map, const bool array_assign = false, int* struct_member = NULL);
