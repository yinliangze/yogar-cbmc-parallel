...
public:
  ...
  bool thread_thread; // create thread in thread

  std::map<irep_idt, unsigned> var_level;
...
protected:
  ...
  void symex_assign_rec(statet &state, const exprt &lhs, const exprt &full_lhs, const exprt &rhs, guardt &guard, visibilityt visibility,const bool array_assign = false,int struct_member = 0);
  void symex_assign_symbol(statet &state, const symbol_exprt &lhs, const exprt &full_lhs, const exprt &rhs, guardt &guard, visibilityt visibility,const bool array_assign = false,int struct_member = 0);
  ...
  void symex_assign_array(statet &state, const index_exprt &lhs, const exprt &full_lhs, const exprt &rhs, guardt &guard, visibilityt visibility,const bool array_assign = false,int struct_member = 0);
  void symex_assign_struct_member(statet &state, const member_exprt &lhs, const exprt &full_lhs, const exprt &rhs, guardt &guard, visibilityt visibility,const bool array_assign = false,int struct_member = 0);
